...
```{r cytoribo_context_Sp,dependson="load_context_Sc",fig.width=4,fig.height=1}
cytoribolist_Sp <- read_tsv("data_out/ComplexOrthologs/cytoribosome_PTRcurated4.txt",
                        comment="#") %>%
