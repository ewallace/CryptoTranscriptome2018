...
```{r plot_inf_perbase,dependson="load_info_perbase",fig.height=4,fig.width=3.6,dev="pdf"}
...
```{r inf_content_bygenesm4ANDm10to5,dependson="load_info_perbase",results="show",fig.height=3.6,fig.width=4,dev="svg"}
...
ggplot(data=infon_tblv10,aes(x=Genes,y=Infon,fill=Organism)) +
    geom_col(position="dodge") +
    geom_col(position="dodge",
             aes(colour="-10:-1",linetype="-10:-1",group=Organism),fill=NA) +
    geom_col(data=infon_tblv4,position="dodge",
             aes(colour="-4:-1",linetype="-4:-1",group=Organism),fill=NA) +
    scale_fill_brewer(type = "qual",palette=3) +
    scale_colour_manual("Kozak width",values=c("-4:-1"="black","-10:-1"="black")) + 
    scale_linetype_manual("Kozak width",values=c("-4:-1"="solid","-10:-1"="11")) +
...
```{r dvsaATG_framemitosumm, dependson="load_dvsa",results="show",fig.width=4,fig.height=3,dev="pdf"}
...
ggplot(data=dvsaATG_framemitosummspread ) +
    ...
    scale_y_continuous(breaks=c(0,1/3,2/3,1),
                       ...
                       expand=c(0,0)) +
    expand_limits(y=0.7) + 
    labs(y="d1AUG prop. in frame",x="Organism") +
