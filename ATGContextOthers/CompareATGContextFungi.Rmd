...
ggplot(data=infon_tblv10,aes(x=Genes,y=Infon,fill=Organism)) +
    geom_col(position="dodge") +
    geom_col(position="dodge",aes(colour="-10:-1",group=Organism),fill=NA) +
    geom_col(data=infon_tblv4,position="dodge",aes(colour="-4:-1",group=Organism),fill=NA) +
    scale_fill_brewer(type = "qual",palette=2) +
    scale_colour_manual("Kozak width",values=c("-4:-1"="black","-10:-1"="grey40")) + 
