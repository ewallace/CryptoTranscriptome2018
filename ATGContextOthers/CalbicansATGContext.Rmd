...
Information content in bits of highly-translated consensus (excluding 6 bits from ATG), **narrow** is `r infontot(kozak_w_PFM_Ca[,5:9]) %>% round(2)`, of **wide** is `r infontot(kozak_w_PFM_Ca[,-(10:12)]) %>% round(2)`.
