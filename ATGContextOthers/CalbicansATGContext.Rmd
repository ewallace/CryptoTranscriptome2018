...
```{r cytoribo_context_Ca,dependson="load_context_Ca",fig.width=4,fig.height=1,eval=FALSE}
cytoribolist_Ca <- read_tsv("data_out/ComplexOrthologs/cytoribosome_PTRcurated4.txt",
                        comment="#") %>%
