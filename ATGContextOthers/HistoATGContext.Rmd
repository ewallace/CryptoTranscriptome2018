...
```{r cytoribo_context_Hc,dependson="load_context_Hc",fig.width=4,fig.height=1,eval=FALSE}
cytoribolist_Hc <- read_tsv("data_out/ComplexOrthologs/cytoribosome_PTRcurated6.txt",
                        comment="#") %>%
    filter(SPECIES=="HISTO") %>%
    .$GENE_ID
