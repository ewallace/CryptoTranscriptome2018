...
# dvsaATG_framemitosummspread_JEC21 <- 
#     dvsaATG_framemitosumm_JEC21 %>%
#     unite(d1f_mito,d1.framefac,Pred_preseq) %>%
#     spread(key=d1f_mito,value=n)
# 
# ggplot(data=dvsaATG_framemitosummspread_JEC21 %>% filter(enoughRNA=="Yes")) +
#     geom_col(aes(x=d1vsaw0p1, 
#                  y=(In_No+In_Yes)/(In_No+In_Yes+Out_No+Out_Yes)),
#              fill="grey50") +
#     geom_col(aes(x=d1vsaw0p1, 
#                  y=(In_Yes)/(In_No+In_Yes+Out_No+Out_Yes)),
#              fill="magenta") +
#     scale_y_continuous(expand=c(0,0)) +
#     labs(y="dATG prop. in frame",x="dATG vs aATG score")
```
