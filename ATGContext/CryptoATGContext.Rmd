...
### Estimate information content per base across all letters
...
plotheat_inf_perbase(inf_content_perbase_JEC21)
...
```{r kozak_consensus_H99,dependson=c("load_context_H99","load_riboviz_H99"),fig.width=4,fig.height=1}
...
plotheat_inf_perbase(inf_content_perbase_H99)
