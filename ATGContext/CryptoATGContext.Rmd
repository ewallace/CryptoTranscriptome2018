...
```{r uATG_aATGwsumm_occ_JEC21, dependson="calc_scores_JEC21", fig.width=4.5,fig.height=2.5}
...
```{r dATG_aATGw_occ_summ_H99, dependson="calc_scores_H99", fig.width=4,fig.height=2.5}
...
```{r uATG_aATGwsumm_occ_H99, dependson="calc_scores_H99", fig.width=4.5,fig.height=2.5}
