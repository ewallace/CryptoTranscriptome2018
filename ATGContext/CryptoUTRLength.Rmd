...
# nAUG_cc_summ
uAUGct_H99vsJEC21 <- 
    ggplot(data=nAUG_cc_summ,aes(x=n_uATG.H99,y=n_uATG.JEC21,size=n)) +
    geom_point(colour="grey50") +
    scale_size_area("no. of\ngenes",breaks=c(1,100,1000)) + 
    # annotate(geom="text",x=1,y=10,label=paste0("R = ",signif(corr_nAUG,2))) +
    coord_equal(xlim=c(0,10),ylim=c(0,10)) + 
    labs(x="H99 uAUG ct.", y="JEC21 uAUG ct.")  +
